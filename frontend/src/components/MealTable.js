    ...
    const doGetFood = () => 
    {
        ...
        axios(config).then(function(response) 
        {
            ...
            {	
                ...
                if(res.meals === undefined)
                {
                    setfood([])
                }
                else
                {
                    setfood(res.meals.sort((a,b) => (a.Name > b.Name) ? 1: -1));
                }
        ...
        <div id="GetWeightDiv">
            <table class="table">
                <thead>
                    ...
                    <th scope="col">Total Protein (Per Serving) </th>
                    <th scope="col">Total Carbohydrates (Per Serving)</th>
                    <th scope="col">Total Sugar (Per Serving)</th>
                    <th scope="col">Total Fat (Per Serving)</th>
                    <th scope="col">Total Sodium (Per Serving)</th>
                    <th scope="col">Total Calories (Per Serving)</th>
                    </tr>
                </thead>
                <tbody>
                    { 
